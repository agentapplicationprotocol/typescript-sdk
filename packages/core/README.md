...
This package is used internally by `@agentapplicationprotocol/client` and `@agentapplicationprotocol/server`. You can also import it directly for type-only usage.

## Installation

```bash
npm install @agentapplicationprotocol/core
```
